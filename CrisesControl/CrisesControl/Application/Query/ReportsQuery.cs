...
namespace CrisesControl.Api.Application.Query {
    public class ReportsQuery : IReportsQuery {
        ...
        public async Task<GetIncidentMessageAckResponse> GetIncidentMessageAck(GetIncidentMessageAckRequest request) {
            ...
            var ackresult = await _reportRepository.GetIncidentMessageAck(request.MessageId, request.MessageAckStatus, request.MessageSentStatus, request.Source,
            ...
            response.Draw = _paging.Draw;

            var result = new GetIncidentMessageAckResponse();
            result.Data = response;
        ...
        public async Task<GetIncidentMessageNoAckResponse> GetIncidentMessageNoAck(GetIncidentMessageNoAckRequest request) {
            var stats = await _reportRepository.GetIncidentMessageNoAck(request.draw, request.IncidentActivationId, request.RecordStart, request.RecordLength, request.SearchString, request.UniqueKey);

            var response = _mapper.Map<List<DataTablePaging>>(stats);
            var result = new GetIncidentMessageNoAckResponse();
            result.data = response;
        ...
        public List<IncidentMessageAuditResponse> GetIncidentMessagesAudit(int incidentActivationId, int companyId) {
            return _reportRepository.GetIncidentMessagesAudit(incidentActivationId, companyId);
        }
        ...
        public async Task<GetIncidentReportDetailsResponse> GetIncidentReportDetails(GetIncidentReportDetailsRequest request) {
            try {
                var messagesRtns = await _reportRepository.GetIncidentReportDetails(request.IncidentActivationId, _currentUser.CompanyId, _currentUser.UserId);
                var response = _mapper.Map<List<IncidentMessagesRtn>>(messagesRtns);
                var result = new GetIncidentReportDetailsResponse();
                if (response != null) {
                    result.data = response;
