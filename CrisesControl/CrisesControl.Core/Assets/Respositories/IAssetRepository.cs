...
namespace CrisesControl.Core.Assets.Respositories
{
    public interface IAssetRepository
    {
        ...
        Task<List<AssetList>> GetAssets(int companyID, int recordStart = 0, int recordLength = 100, string searchString = "",
        ...
        public Task<AssetsDetails> GetAsset(int companyId, int assetId);
