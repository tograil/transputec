...
public class IncidentPingGroupRatingLocationConfiguration : IEntityTypeConfiguration<IncidentPingGroupRatingLocation>
{
    public void Configure(EntityTypeBuilder<IncidentPingGroupRatingLocation> builder)
    {
        builder.HasNoKey();

        builder.ToView("IncidentPingGroupRatingLocation");
